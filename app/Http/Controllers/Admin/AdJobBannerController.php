...
class AdJobBannerController extends Controller
{
    use Helper;
    ...
    {
        return view('admin.ads_banner-job.index');
    }

    public function create()
    {
        return view('admin.ads_banner-job.add')->withEdit(false);
    }

    public function store(Request $request)
    {
        $data = $request->all();
        $path = 'public/uploads/ads_banner-job/';
    ...
    {
        $ads = AdBanner::all();
        return view('admin.ads_banner-job.add')->withEdit(true)->withAds($ads);
    }
