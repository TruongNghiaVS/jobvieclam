...
class BannerAdController extends Controller
{
    ...
    {
        return view('admin.bannerAd.index');
    }

    public function createCms()
    {
        return view('admin.bannerAd.add');
    }
    ...
    public function storeCms(CmsFormRequest $request)
    {
        ...
        return \Redirect::route('edit.bannerAd', array($cms->id));
    }

    public function editCms($id)
    {
        $cms = Cms::findOrFail($id);
        return view('admin.bannerAd.edit', compact('cms'));
    }
    ...
    public function updateCms($id, CmsFormRequest $request)
    {
        ...
        return \Redirect::route('bannerAd.cms', array($cms->id));
    }
