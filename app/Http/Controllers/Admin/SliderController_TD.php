...
class SliderController_TD extends Controller
{
    ...
    public function indexSliderTD()
    {
        $languages = DataArrayHelper::languagesNativeCodeArray();
        return view('admin.sliderTD.index')->with('languages', $languages);
    }

    public function createSliderTD()
    {
        $languages = DataArrayHelper::languagesNativeCodeArray();
        $sliders = DataArrayHelper::defaultSlidersArray();
        return view('admin.sliderTD.add')
    ...
    public function storeSliderTD(SliderFormRequest $request)
    {
        ...
        if ($request->hasFile('slider_image_3')) {
            $image_name = $request->input('slider_heading');
            $fileName = ImgUploader::UploadImage('slider_images', $request->file('slider_image_3'), $image_name, 600, 1368);
            $slider->slider_image_3 = $fileName;
            $slider->used_for = 1;
        }
    ...
    public function editSlider($id)
    {
        ...
        return view('admin.sliderTD.edit')
                        ->with('slider', $slider)
                        ->with('languages', $languages)
                        ->with('sliders', $sliders);
    }
    ...
    {
        $languages = DataArrayHelper::languagesNativeCodeArray();
        return view('admin.sliderTD.sort')->with('languages', $languages);
    }
