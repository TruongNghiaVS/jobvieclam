                ...
                <div class="col-lg-12">
                    <section class="content-header">
                        <div class="panel-heading">
                            ...
                            <ul class="breadcrumb">
                                <li class="active"><a href="{{ URL::asset('/admin/blog')}}"><i class="fa fa-dashboard"></i> Quản lý Blogs Tuyển Dụng </a></li>
                                <li><a href="{{ URL::asset('/admin/blog_category')}}"><i class="fa fa-file-text-o"></i>
                                        Quản lý Danh mục Tuyển Dụng</a></li>
