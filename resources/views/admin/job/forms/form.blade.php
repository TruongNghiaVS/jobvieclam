...
<style type="text/css">
    ...
    .user-account-section {
        background: #ffffff;
        -webkit-box-shadow: 0px 1px 3px rgba(96, 108, 128, 0.1);
        box-shadow: 0px 1px 3px rgba(96, 108, 128, 0.1);
        border-radius: 8px;
        padding: 20px;
        margin-bottom: 30px;
    }
...
<div class="form-body job-edit">     
    ...
    <div class="button-group justify-content-center" bis_skin_checked="1">
