...
<div class="page-content-wrapper"> 
    ...
    <div class="page-content"> 
        ...
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Quản lý Sliders TD <small>Danh sách Sliders TD</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Sliders TD</span> </div>
                        <div class="actions"> <a href="{{ route('createTD.slider') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> Thêm Slider TD</a> </div>
                    </div>
