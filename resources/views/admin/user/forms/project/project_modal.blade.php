    ...
    <div class="modal-content">
        <form class="form" id="add_edit_profile_project" method="POST" action="{{ route('store.profile.project', [$user->id]) }}">{{ csrf_field() }}
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-large btn-primary" onClick="submitProfileProjectForm();">Thêm Dự án <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
            </div>
        </form>
    </div>
    <!-- /.modal-content --> 
