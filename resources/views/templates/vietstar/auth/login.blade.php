                ...
                <div class="userccount">
                    ...
                    <div class="tab-content">
                        <div id="candidate" class="formpanel tab-pane {{($c_or_e == 'candidate')? 'active':''}}">
                            <div class="socialLogin">
                                ...
                                <a href="{{ url('login/jobseeker/facebook')}}" class="fb"><i class="fab fa-facebook-f" style='color:red;'></i></a>
                                <a href="{{ url('login/jobseeker/google')}}" class="gp"><i class="fab fa-google"></i></a>
                    ...
                    <!-- sign up form end-->
                        ...
                        <div id="employer" class="formpanel tab-pane fade {{($c_or_e == 'employer')? 'active':''}}">
                            <div class="socialLogin">
                                <h5>{{__('Login with Social')}}</h5>
                                <a href="{{ route('facebook.redirect.employer')}}" class="fb"><i class="fab fa-facebook-f "></i></a>
                                <a href="{{ route('facebook.callback.employer')}}" class="gp"><i class="fab fa-google"></i></a>
                            </div>
