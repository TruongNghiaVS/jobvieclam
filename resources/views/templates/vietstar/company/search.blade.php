...
<!-- Dashboard menu end -->
<div class="company-wrapper listpgWraper  company-list-wrapper">
                ...
                <div class="topcompanyhead__search row">
                    <div class="search-company col-6">
                        ...
                        <div class="d-flex flex-row search__box">
                            <input type="search" class="" id="keyword" name="keyword" placeholder="{{__('Skills or Job Titles')}}" value="{{$keyword}}" autocomplete="off">
                        </div>
    ...
    <div class="row">
        <div class="col-lg-9">
            ...
            <div class="box-result bg-white">
                @if($companies)
                    @foreach($companies as $company)
                    <div data-job-id="47" class="item-company mb-3" bis_skin_checked="1">
                        <div class="logo-company" bis_skin_checked="1">
                            <a href="" title="FPT INFORMATION SYSTEM" class="pic">
                                {{$company->printCompanyImage()}}
                            </a>
                        </div>
                        <div class="company-info" bis_skin_checked="1">
                            <div class="info" bis_skin_checked="1">
                                ...
                                <div class="info-item my-2" bis_skin_checked="1">
                                    <div class="info-item__location" bis_skin_checked="1">
                                        <i class="bi bi-geo-alt text-primary"></i>
                                        <p class="mx-2">
                                        @if($company->location) {{__(('Address'))}} :   {{$company->location}} @endif
                                        </p>
                                    </div>
                                </div>

                                <div class="info-item my-2" bis_skin_checked="1">
                                    <div class="info-item__des" bis_skin_checked="1">
