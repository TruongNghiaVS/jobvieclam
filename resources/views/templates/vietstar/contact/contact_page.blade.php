                        ...
                        <div class="contact-form">
                            ...
                            <form method="post" action="{{ route('post.contact.us')}}" name="contactform" id="contactform">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <button title="" class="btn btn-primary btn-submit" type="submit"
                                            id="submit">{{__('Submit Now')}} <i class="far fa-paper-plane"></i></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="col-lg-6 column">
                        <div class="contact" style="height: auto">
                            ...
                            <div class="information">
                                <p><i class="fa fa-phone mr-2" style="color: #951B1E; margin-right: 10px"></i><a
                            ...
                            <div class="information">
                                <p><i class="fa fa-envelope mr-2" style="color: #951B1E; margin-right: 10px"></i><a
