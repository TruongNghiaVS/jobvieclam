                    ...
                    <div class="col-md-6 col-lg-4 mb-3">
                      <div class="card-news w-100">
                        ...
                        <div class="card-news__content">
                          <button class="btn-pin-job active" type="button"><span class="iconmoon icon-flag"></span></button>  
                          <h6 class="card-news__content-title"><a href="{{route('job.detail', [$allJob->slug])}}" title="{{$allJob->title}}">{{$allJob->title}}</a></h6>
                          ...
                          <div class="card-news__content-footer">
                            <div class="card-news__content-footer__location">
                              <span class="badge rounded-pill pill pill-location">{{$allJob->getCity('city')}}</span>
                              <span class="badge rounded-pill pill pill-worktime">{{$allJob->getJobType('job_type')}}</span>
                            </div>
                            <div class="card-news__content-footer__salary">
                            {{ $allJob->salary_from }} - {{ $allJob->salary_to }} ({{ $allJob->salary_currency }})
                            </div>
                          </div>
                        </div>
                      </div>
