    ...
    <div class="container nav">
        ...
        <div class="collapse navbar-collapse main-menu" id="navbarNavAltMarkup">
            ...
            <div class="d-flex gap-10 my-2 group-button">
                ...
                <a class="nav-link" data-toggle="modal" data-target="#user_login_Modal">{{__('Log in')}} / {{__('Đăng ký')}} </a>
                <a class="nav-link login_link btn btn-primary login-btn" href="{{route('login')}}">Nhà tuyển dụng</a>
