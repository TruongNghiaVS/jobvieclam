                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title"
                                               placeholder="{{__('Job title')}}" value="{{ $edit && isset($job) ? __($job->title) : old('title') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="expiry_date" name="expiry_date"
                                               placeholder="Deadline" value="{{ $edit && isset($job) ? \Carbon\Carbon::parse($job->expiry_date)->format('d-m-Y') : \Carbon\Carbon::parse(old('expiry_date'))->format('d-m-Y') }}" >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="WFH">{{__('WFH')}} <span class="required">*</span></label>
                                        @php($wfhs = [\App\Job::JOB_WFH_YES=>'Yes',\App\Job::JOB_WFH_NO=>'No'])
                                        <select required class="form-control form-select" id="wfh_id" name="wfh_id">
                                            <option value="">{{ __('Work from home') }}</option>
                                            @if(count($wfhs) > 0)
                                            @foreach($wfhs as $key => $value)
                                            <option {{ isset($job) && $job->wfh_id == $key ? 'selected' : '' }} value="{{ $key }}">{{ $value }}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('gender_id', [0 => __('No Preference')]+$genders, null, array('class'=>'form-control form-select', 'id'=>'gender_id')) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="num_of_positions" name="num_of_positions"
                                               placeholder="{{__('Number of positions')}}" value="{{ $edit && isset($job) ? $job->num_of_positions : old('num_of_positions') }}" >
                                ...
                                <div class="col-md-12">
                                    <div class="form-group" id="pow_address" style="display:none;">
                                        ...
                                        <input type="text" class="form-control" id="location" name="location"
                                               placeholder="{{__('Location')}}" value="{{ $edit && isset($job) ? $job->location : old('location') }}" >
                                    </div>
                                </div>
