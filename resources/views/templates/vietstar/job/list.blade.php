                        ...
                        <div data-job-id="{{$job->id}}" {{$attrs}} class="item-job mb-3">
                            <div class="logo-company">
                                <a href="{{route('company.detail', $company->slug)}}" title="{{$company->name}}"
                                    class="pic">{{$company->printCompanyImage(140, 140)}}</a>
                            </div>
                            <div class="jobinfo">
                                <div class="info">
                                    <!-- Title  Start-->
                                    <div class="info-item job-title-box">
                                        ...
                                        <a class="save-job" href="{{route('add.to.favourite', $job->slug)}}"><i
                                    ...
                                    <!-- companyName Start-->
                                    <div class="info-item companyName"><a
                                ...
                                <div class="caption">
                                    ...
                                    <div class="user-actio">
                                        ...
                                        <a class="save-job box-meta"
                                            href="{{route('remove.from.favourite', $job->slug)}}"><i
                                                class="fas fa-heart iconoutline"></i>
