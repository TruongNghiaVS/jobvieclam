                ...
                <div class="col-lg-9 col-sm-12">
                    ...
                    <div class="searchList jobs-side-list">
                        ...
                        @if(isset($jobs) && count($jobs)) <?php $count_1 = 1; ?> @foreach($jobs as $job) @php $company =
                            ...
                            <?php }else{ ?>
                        @php
                        $props = ["title", "job_type", "job_experience_id", "state_id", "city_id", "job_type_id", "salary_currency", "salary_from", "salary_to",
                        ...
                        <div data-job-id="{{$job->id}}" {{$attrs}} class="item-job mb-3">
                            <div class="logo-company">
                                 <a href="{{route('company.detail', $company->slug)}}" title="{{$company->name}}" class="pic">{{$company->printCompanyImage(132, 132)}}</a>
                            </div>
                            <div class="jobinfo">
                                <div class="info">
                                    ...
                                    <div class="box-meta">
                                        <i class="fas fa-user-astronaut"></i>{{$job->getJobType('job_type')}}
                                    </div>
                                    <div class="box-meta box-meta-rank-salary">
                                        <div class="meta-city">
                                ...
                                <div class="caption">
                                    <div class="welfare">
                                        <div class="box-meta">
                                            <i class="fas fa-dollar-sign"></i> {{__('Rewards')}}
                                        </div>
                                        <div class="box-meta">
                                    ...
                                    <div class="user-actio">
                                        ...
                                        @else 
                                            <a class="save-job box-meta" href="{{route('add.to.favourite', $job->slug)}}"><i class="far fa-heart"></i>
