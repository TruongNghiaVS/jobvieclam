...
@section('content')
    ...
    @include('templates.vietstar.includes.inner_page_title', ['page_title' => __('Change Template')])
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="group-button-cv-template ">
                        ...
                        <!-- Lưu lại thông tin CV -->
                        <button type="submit" class="btn btn-primary" onclick="Convert_HTML_To_PDF();">{{ __('Save this CV') }}</button>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="col-tools">
                                <div class="tools-schemes">
                                    <div class="head-tools">
                                        ...
                                        <button type="button" class="tips" data-toggle="modal"
                                                ...
                                                <div class="list-tools">
                                                    <div class="item-tools">
                                                        ...
                                                        <div class="template">
                                                            ...
                                                            <div class="change"><a href="javascript:void(0);"
                                                                    data-toggle="modal" data-target="#modalChooseTemplate"
                                                                    class="btn-change-template">Đổi Mẫu</a></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="item-tools">
                                                        ...
                                                        <div class="language">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-select" name="cv_language"
                                                                    id="cv_language">
                                                                    <option value="vi"
                                                    ...
                                                    <div class="item-tools">
                                                        ...
                                                        <div class="list-font-size">
                                                            <div class="font-size font-size-12">
                                                                <input type="radio" class="radio-font" name="fontSize"
                                                                    id="fontSize12" value="12"
                                                                    {{ $cv_template->font_size == 12 ? 'checked' : '' }}>
                                                                <span class="label-fontsize">A</span>
                                                            </div>
                                                            <div class="font-size font-size-14">
                                                                <input type="radio" class="radio-font" name="fontSize"
                                                                    id="fontSize14" value="14"
                                                                    {{ $cv_template->font_size == 14 ? 'checked' : '' }}>
                                                                <span class="label-fontsize">A</span>
                                                            </div>
                                                            <div class="font-size font-size-16">
                                                                <input type="radio" class="radio-font" name="fontSize"
                                                                    id="fontSize16" value="16"
                                                                    {{ $cv_template->font_size == 16 ? 'checked' : '' }}>
                                                                <span class="label-fontsize">A</span>
                                                            </div>
                                                        </div>
                                                    </div>
