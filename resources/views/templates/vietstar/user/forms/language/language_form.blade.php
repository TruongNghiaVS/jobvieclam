<div class="modal-body" id="botienxunhano">
    <div class="form-body">
        <div class="formrow" id="div_language_id">
            ...
            {!! Form::select('language_id', [''=>__('Select language')] + $languages, $language_id, array('class'=>'form-control form-select', 'id'=>'language_id')) !!} <span class="help-block language_id-error"></span> </div>
        <div class="formrow" id="div_language_level_id">
            {!! Form::select('language_level_id', [''=>__('Select Language Level')], null, array('class'=>'form-control form-select', 'id'=>'language_level_id')) !!} <span class="help-block language_level_id-error"></span> </div>
    </div>
</div>
@push('scripts')
    <script>
