...
<div class="section-head">
        ...
        <div class="section-head__right-action" bis_skin_checked="1">
                <div class="right-action__tips" bis_skin_checked="1" data-toggle="modal" data-target="#references-tip">
                        <i class="bi bi-lightbulb"></i>
                        <p>Tips</p>
                </div>
                <div class="right-action__link-edit"><a  href="javascript:;"  onclick="showProfileReferencesModal();"><i class="bi bi-pen"></i>Thêm mới</a></div>
                <div class="right-action__link-edit-mobile"><a  href="javascript:;"  onclick="showProfileReferencesModal();"><i class="bi bi-pen"></i></a></div>
