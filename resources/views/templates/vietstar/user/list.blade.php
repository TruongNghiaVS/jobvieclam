                    ...
                    <div class="col-lg-10">
                        <div class="searchform">
                            <div class="row">
                                ...
                                <div class="col-md-2"> {!! Form::select('functional_area_id[]', ['' => __('Lựa chọn Bộ phận chức năng')]+$functionalAreas, Request::get('functional_area_id', null), array('class'=>'form-control', 'id'=>'functional_area_id')) !!} </div>
...
<div class="listpgWraper">
    <div class="container">
        ...
        <form action="{{route('job.seeker.list')}}" method="get">
            ...
            <div class="row"> @include('templates.vietstar.includes.job_seeker_list_side_bar')                
                <div class="col-lg-6"> 
                    <!-- Search List -->
                    <ul class="searchList">
                        <!-- job start --> 
                        ...
                        <li>
                            ...
                            <p>{{\Illuminate\Support\Str::limit(strip_tags($jobSeeker->getProfileSummary('summary')),150,'...')}}</p>
                        </li>
                        <!-- job end --> 
                        @endforeach
                        @endif
