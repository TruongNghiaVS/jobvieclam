...
Route::get('danh-sach-ung-tuyen', 'Job\JobController@myJobApplications')->name('my.job.applications');
Route::get('list-rejected-users/{id}', 'Company\CompanyController@listRejectedUsers')->name('rejected-users');
Route::get('cong-viec-yeu-thich', 'Job\JobController@myFavouriteJobs')->name('my.favourite.jobs');
